...
import { CustomTabPanelProps, FilmProps } from './CustomProps';
...
export default function News() {
    ...
    const updateFavo = async (filmID: number, userID: string) => {
    ...
    const handelFavo = async (filmID: number, filmName: string, notFavo: string, userID: string | undefined) => {
        let newValue: string;
                                    ...
                                    <Card className='custom_card'>
                                        ...
                                        <CardContent className='custom_card_content'>
                                            ...
                                            <Box className='content_favo'>
                                                ...
                                                <IconButton onClick={() => { handelFavo(film.id, film.name, favoFilms[film.id - 1], userContext?.user?.id) }}>
                                ...
                                <Box className='custom_film'>
                                    {isValidURL(newsItem.clip) ?
                                        <Box
                                            component="iframe"
                                            borderRadius={'1rem'}
                                            width={'99%'} height={'35em'} src={newsItem.clip} frameBorder="0"
